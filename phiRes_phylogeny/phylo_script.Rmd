...
if(!require("seqinr")) install.pakages("seqinr")
...
filelist<-list.files("Kohama", pattern = "fasta", full.names= TRUE)
seq<-Biostrings::readDNAStringSet(filelist)
seq<-RNA2DNA(seq)

```
```{r file read DEPRECATED DONT USE, eval=FALSE, include=FALSE}


#####DONT RUN THIS.  IT WILL BE DEPRECATED WHEN I AM CONFIDENT THE OTHER FILE READ SCRIPT WORKS#####
