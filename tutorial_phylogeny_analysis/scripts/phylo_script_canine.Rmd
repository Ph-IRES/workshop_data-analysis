...
writeXStringSet(as(unmasked(seqalign), "XStringSet"), file="../output/aln.fasta")
nt<-readDNAMultipleAlignment("../output/aln.fasta", format = "fasta")
...
##Manipulations to trees can be done using the ggtree manual, to be found here: https://yulab-smu.top/treedata-book/index.html
##You should create new treeplot from the basic called treeplot_mod and build out a ggtree command in the usual way
#examples of specific mods are given below; your final tree should consist of one ggplot block

##create dataframe for metadata
#see https://yulab-smu.top/treedata-book/chapter5.html
